    ...
    isPopupOpened && (
      <div className="popup-popup-overlay">
        <div className="popup-popup-container">
          ...
          <div className="popup-popup-containr">
                    ...
                    <div className="popup-popup-home-types-booking-container">
                      <ul className="popup-popup-home-types-list">
                        {test.visit_type.split(", ").map((type, index) => (
                          <li
                            key={index}
                            className="popup-popup-home-type-item"
                          >
                            {type}
                          </li>
                        ))}
        ...
        {clickedIds.length > 0 && (
          <div className="popup-popup-bottom-cart-card">
            <div className="popup-popup-bottom-cart-card-sub-container">
              <Link to="/cart">
                <div>
                  <FaCartArrowDown className="popup-popup-bottom-cart-icon" />
                </div>
              </Link>
              <h3>
            ...
            <button
              className="popup-popup-proceed-btn popup-popup-btn-primary align-self-end"
